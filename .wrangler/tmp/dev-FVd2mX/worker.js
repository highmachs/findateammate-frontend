...
var Global = class extends Server {
  ...
  async onConnect(conn, ctx) {
    ...
    const currentState = await this.storage.get("maintenance") ?? false;
...
// .wrangler/tmp/bundle-lQUF8a/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lQUF8a/middleware-loader.entry.ts
